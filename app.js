...
var twitterPI = require('./twitterpi');
...
app.post( '/api/message', function(req, res) {
  ...
  // Send the input to the conversation service
	  ...
	  tone_analyzer.tone({text: reftext}, function (taerr, tadata) {
	    ...
	    if(payload.context.getPI) {
	      var twthandle = payload.context.handle;
	      var handle = twthandle.replace('@','');
	      twitterPI(handle, function(PIresult) {
            	payload.context.PImusicType = PIresult;
